...
class SemanticScoreResult:
    ...
    # GPT-refined n-gram occurrences (list of dicts with ngram, type, category, priority_score, etc.)
    refined_ngrams: Optional[List[Dict]] = None
    # SEO brief generated by GPT (title, meta_description, h1, sections)
